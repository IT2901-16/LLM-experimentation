...
st.set_page_config(page_title='Llama2 interne rutiner chatbot')
st.header('Interne rutiner chatbot :robot_face:')
...
def get_user_input():
    ...
    # get the user query
    input_text = st.text_input('Spør meg om interne rutiner i Trondheim Kommune', "", key='input')
    return input_text
